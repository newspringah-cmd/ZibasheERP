...
پیام درخواست در گروه آماده‌سازی بسته دکمه‌های «ارسال شد» و «ارسال کد رهگیری» دارد. مسئول ارسال با دکمه دوم عکس بعدی را به همان مشتری اختصاص می‌دهد و ربات آن را به همه گروه‌های فعال متصل به مشتری ارسال می‌کند؛ `/cancel` انتظار عکس را لغو می‌کند.
