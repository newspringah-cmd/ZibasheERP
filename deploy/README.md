...
کلید OpenAI نباید در Git یا لاگ‌ها ثبت شود. خروجی یک PDF تک‌صفحه‌ای افقی با اندازه دقیق ۸۰ در ۵۰ میلی‌متر و فونت B Nazanin جاسازی‌شده است. نام گیرنده، نشانی، تلفن و شهر مقصد الزامی‌اند؛ کدپستی اختیاری است و در صورت نبودن از لیبل حذف می‌شود. اگر یکی از اطلاعات الزامی از متن خام قابل استخراج نباشد، PDF ساخته نمی‌شود و پیام اصلاح اطلاعات برای حسابدار ارسال می‌شود.
