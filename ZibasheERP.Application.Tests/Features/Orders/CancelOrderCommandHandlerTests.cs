...
public sealed class CancelOrderCommandHandlerTests
{
    ...
    private sealed class OutboxRepositoryStub : INotificationOutboxRepository
    {
        ...
        public Task<IReadOnlyCollection<NotificationOutbox>> GetPendingAsync(int limit, CancellationToken cancellationToken = default) => Task.FromResult<IReadOnlyCollection<NotificationOutbox>>(Array.Empty<NotificationOutbox>());
