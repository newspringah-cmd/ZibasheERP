...
namespace ZibasheERP.Infrastructure.Migrations
{
    ...
    [Migration("20260925125743_AddStableSalesListPublicCode")]
    partial class AddStableSalesListPublicCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.Address", b =>
                {
                    ...
                    b.Property<string>("RegistrationTelegramChatId")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.Property<string>("TelegramInvoiceChatId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime?>("ArrivedInIranAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("DecantedAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("EnteredDecantQueueAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<Guid?>("ShippingRequestId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("ShippingRequestedAt")
                        .HasColumnType("datetime2");

                    b.Property<long?>("ShippingTelegramMessageId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FulfillmentStatus", "SalesListId");
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.Perfume", b =>
                {
                    ...
                    b.Property<string>("TelegramLogoFileId")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.SalesList", b =>
                {
                    ...
                    b.Property<int?>("StablePublicCode")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.SalesListRequest", b =>
                {
                    ...
                    b.Property<bool>("IsComplimentaryBottle")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.TelegramBlockedUsername", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("BlockedByTelegramUserId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("TelegramBlockedUsernames");
                });
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.TrackingDispatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Carrier", "TrackingCode")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("TrackingDispatches");
                });

            modelBuilder.Entity("ZibasheERP.Domain.Entities.TrackingDispatchDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TrackingDispatchId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TrackingDispatchId", "TelegramChatId")
                        .IsUnique();

                    b.ToTable("TrackingDispatchDeliveries");
                });

            modelBuilder.Entity("ZibasheERP.Domain.Entities.TrackingImportBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TrackingImportBatches");
                });
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.TrackingDispatch", b =>
                {
                    ...
                    b.HasOne("ZibasheERP.Domain.Entities.TrackingImportBatch", "ImportBatch")
                        .WithMany("Dispatches")
            ...
            modelBuilder.Entity("ZibasheERP.Domain.Entities.TrackingDispatchDelivery", b =>
                {
                    b.HasOne("ZibasheERP.Domain.Entities.TrackingDispatch", "TrackingDispatch")
                        .WithMany("Deliveries")
                        .HasForeignKey("TrackingDispatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TrackingDispatch");
                });
